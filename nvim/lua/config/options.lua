...
vim.opt.softtabstop = 2 -- use 2 spaces in insert mode

-- Search
vim.opt.hlsearch = true -- highlight all matches on previous search pattern
vim.opt.ignorecase = true -- ignore case in search patterns
vim.opt.incsearch = true -- show matches as the search text changes
vim.opt.smartcase = true -- when searches include capitals try to use case sensitve searching
